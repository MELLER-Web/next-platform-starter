    ...
    return (
        <div className="flex flex-col gap-12 sm:gap-16 lg:gap-20 py-8 sm:py-12 lg:py-16">
            <section className="text-center py-8 sm:py-12 lg:py-16 animate-fade-in-up">
                <h1 className="mb-6 sm:mb-8 lg:mb-10">Onze Prijzen</h1>
                ...
                <div className="space-y-8 sm:space-y-10 lg:space-y-12">
                    {prijzen.map((categorie, catIndex) => (
                        <div key={categorie.category} className="animate-fade-in-up" style={{ animationDelay: `${catIndex * 0.1}s` }}>
                            <h2 className="mb-6 sm:mb-8 text-2xl sm:text-3xl">{categorie.category}</h2>
                                    ...
                                    >
                                        <div className="flex flex-col gap-3">
                                            ...
                                            <div className="flex items-center justify-between pt-2 border-t border-neutral-200 dark:border-neutral-700">
                                                <span className="text-2xl sm:text-3xl font-bold text-[#6366f1]">
                                                    {service.prijs}
                                                </span>
            ...
            <section className="py-8 sm:py-12 lg:py-16 border-t border-neutral-200 dark:border-neutral-800">
                <Card className="max-w-2xl mx-auto animate-fade-in-up" style={{ animationDelay: '0.5s' }}>
                    <h2 className="mb-6 sm:mb-8 text-center">Belangrijke Informatie</h2>
                    <div className="space-y-4 text-sm sm:text-base">
                        <div className="flex items-start gap-3">
                            <span className="w-2 h-2 rounded-full bg-[#6366f1] mt-2 flex-shrink-0"></span>
                            <p>
            ...
            <section className="py-8 sm:py-12 lg:py-16 border-t border-neutral-200 dark:border-neutral-800 text-center">
                <h2 className="mb-6 sm:mb-8">Klaar om te Boeken?</h2>
